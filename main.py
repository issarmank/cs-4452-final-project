...
#Not seting up device rn, can add later if we want
...
"""
This is an example of how to run the loops with a dynamic nn. The hidden_layers list can be changed to make any architecture
The train and test model functions print the loss and accuracy, this got 96% accuracy with 5 epochs
-------------------------------------------------------------------------------------
hidden_layers = [INPUT_SIZE, 64, 32, 16, NUM_CLASSES]
